...
export default function WorkoutPlan() {
  ...
  const workouts = [
    {
      day: "Monday",
      workout: "Cardio: 30 mins running, Strength Training: Upper body",
    },
    { day: "Tuesday", workout: "Yoga: Flexibility and Core" },
    {
      day: "Wednesday",
      workout: "Cardio: 45 mins cycling, Strength Training: Lower body",
    },
    { day: "Thursday", workout: "Rest Day or Light Walk" },
    {
      day: "Friday",
      workout: "HIIT: 20 mins intervals, Strength Training: Full body",
    },
