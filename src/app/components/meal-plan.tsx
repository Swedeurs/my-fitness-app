  ...
  const meals = [
    {
      ...
      meals: [
        {
          mealType: "Breakfast",
          meal: "Vegan Breakfast Smoothie",
          recipe: "Ingredients: Banana, spinach, almond milk, chia seeds",
        },
        {
          mealType: "Lunch",
          meal: "Quinoa Salad",
          recipe: "Ingredients: Quinoa, chickpeas, cucumber, olive oil, lemon",
        },
        {
          mealType: "Dinner",
          meal: "Stir-fry Vegetables",
          recipe:
            "Ingredients: Bell peppers, broccoli, soy sauce, ginger, garlic",
        },
      ],
    },
    {
      ...
      meals: [
        {
          ...
          recipe: "Ingredients: Oats, mixed berries, almond butter",
        },
        {
          mealType: "Lunch",
          meal: "Chickpea Wrap",
          recipe: "Ingredients: Chickpeas, lettuce, cucumber, wraps",
        },
        {
          mealType: "Dinner",
          meal: "Veggie Tacos",
          recipe: "Ingredients: Corn tortillas, black beans, avocado, salsa",
        },
      ],
    },
    {
      ...
      meals: [
        {
          mealType: "Breakfast",
          meal: "Green Smoothie",
          recipe: "Ingredients: Kale, pineapple, mango, almond milk",
        },
        {
          mealType: "Lunch",
          meal: "Mixed Greens Salad",
          recipe:
            "Ingredients: Lettuce, tomatoes, carrots, cucumber, olive oil",
        },
        {
          mealType: "Dinner",
          meal: "Baked Tofu with Rice",
          recipe: "Ingredients: Tofu, rice, soy sauce, sesame oil",
        },
      ],
    },
    {
      ...
      meals: [
        {
          mealType: "Breakfast",
          meal: "Chia Pudding",
          recipe: "Ingredients: Chia seeds, coconut milk, maple syrup",
        },
        {
          mealType: "Lunch",
          meal: "Buddha Bowl",
          recipe: "Ingredients: Rice, veggies, hummus, tahini sauce",
        },
        {
          mealType: "Dinner",
          meal: "Stuffed Peppers",
          recipe: "Ingredients: Bell peppers, quinoa, black beans, cheese",
        },
      ],
    },
    {
      ...
      meals: [
        {
          ...
          recipe: "Ingredients: Oats, protein powder, almond milk, banana",
        },
        {
          mealType: "Lunch",
          meal: "Sweet Potato Curry",
          recipe: "Ingredients: Sweet potatoes, coconut milk, curry paste",
        },
        {
          mealType: "Dinner",
          meal: "Pesto Pasta",
          recipe: "Ingredients: Pasta, basil pesto, cherry tomatoes, pine nuts",
        },
      ],
    },
  ];
