  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh', backgroundColor: '#0a0a0a', color: '#e0e0e0' }}>
      ...
      <main style={{ flex: '1', padding: '2.5rem', maxWidth: '96rem', margin: '0 auto' }}>
        ...
        {trainer ? (
          <div style={{ borderRadius: '0.5rem', padding: '1.5rem', backgroundColor: '#1a1a1a', boxShadow: '0px 4px 6px rgba(0, 0, 0, 0.1)', marginBottom: '2.5rem' }}>
            <p style={{ fontSize: '1.25rem', fontWeight: 'bold' }}>{trainer.name}</p>
            <p style={{ color: '#999999', marginBottom: '1rem' }}>{trainer.email}</p>
            <button
          ...
          <div style={{ borderRadius: '0.5rem', padding: '1.5rem', backgroundColor: '#1a1a1a', boxShadow: '0px 4px 6px rgba(0, 0, 0, 0.1)', marginBottom: '2.5rem' }}>
            <p style={{ fontSize: '1.25rem', fontWeight: 'bold', color: '#e0e0e0', marginBottom: '1rem' }}>
